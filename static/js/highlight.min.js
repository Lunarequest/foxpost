...
}]}}})();hljs.registerLanguage("wasm",e)})();/*! `bash` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("django",e)})();/*! `vim` grammar compiled for Highlight.js 11.7.0 */
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `awk` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("dockerfile",e)})();/*! `nginx` grammar compiled for Highlight.js 11.7.0 */
...
illegal:"[^\\s\\}\\{]"}}})();hljs.registerLanguage("nginx",e)})();/*! `scss` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict"
