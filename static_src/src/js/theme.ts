...
function share_on_mastodon() {
	let contentelm = document.getElementById("content") as HTMLTextAreaElement | null;
	let instance_urlform = document.getElementById("instance_url") as HTMLInputElement | null;
