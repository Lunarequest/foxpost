...
function ShareOnMastodon (): void {
  const contentelm = document.getElementById('content') as HTMLTextAreaElement | null
  const InstanceUrlform = document.getElementById('instance_url') as HTMLInputElement | null
